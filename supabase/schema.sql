...
values
  ...
  ('dr-woolrich', 'cita_agendada', 'Cita agendada', '#20c997', 'automatic', 3),
  ('dr-woolrich', 'asistio_consulta', 'Asistió a consulta', '#ff9f43', 'manual', 4),
  ('dr-woolrich', 'cirugia_agendada', 'Cirugía agendada', '#f368e0', 'manual', 5),
  ('dr-woolrich', 'cita_cancelada', 'Cita cancelada', '#ff6b6b', 'manual', 6)
